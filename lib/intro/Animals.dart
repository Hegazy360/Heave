...
class AnimalsIntro extends StatefulWidget {
  AnimalsIntro({Key key}) : super(key: key);

  @override
  AnimalsIntroState createState() => AnimalsIntroState();
}

class AnimalsIntroState extends State<AnimalsIntro> {
